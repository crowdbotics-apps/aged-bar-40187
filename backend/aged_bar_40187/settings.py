"""
Django settings for aged_bar_40187 project.
...
ROOT_URLCONF = 'aged_bar_40187.urls'
...
WSGI_APPLICATION = 'aged_bar_40187.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_bar_40187 API",
    "DESCRIPTION": "API documentation for aged_bar_40187 App",
    "VERSION": "v1",
}
